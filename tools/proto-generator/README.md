...
생성 후 Go gRPC 코드는 프로젝트 루트에서 컴파일합니다:
...
VPP proto 정의는 `proto/` 디렉토리에 생성되며, 최종 컴파일 대상은 `proto/vpp/agent.proto`입니다.
...
- TNC proto(`proto/tnc/tnc.proto`)는 이 도구의 생성 대상이 아님 (수동 관리)
