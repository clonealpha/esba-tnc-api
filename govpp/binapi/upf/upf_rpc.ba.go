...
type RPCService interface {
	...
	UpfGetTest(ctx context.Context, in *UpfGetTest) (*UpfGetTestReply, error)
	...
	UpfSetTest(ctx context.Context, in *UpfSetTest) (*UpfSetTestReply, error)
...
func (c *serviceClient) UpfGetTest(ctx context.Context, in *UpfGetTest) (*UpfGetTestReply, error) {
	out := new(UpfGetTestReply)
	err := c.conn.Invoke(ctx, in, out)
	if err != nil {
		return nil, err
	}
...
func (c *serviceClient) UpfSetTest(ctx context.Context, in *UpfSetTest) (*UpfSetTestReply, error) {
	out := new(UpfSetTestReply)
	err := c.conn.Invoke(ctx, in, out)
	if err != nil {
		return nil, err
	}
